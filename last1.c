...
void removestr(){
    ...
    if(strcmp(dashpos, "--pos") != 0 || strcmp(dashsize, "--size") != 0){
        printf("invalid command\n");
        return;
    }

    if(strcmp(dashdir, "-f") != 0 && strcmp(dashdir, "-b") != 0){
        printf("invalid command\n");
        return;
    }
...
int main(){
    ...
    while(1){
        ...
        if (strcmp(operation, "createfile") == 0){
            ...
            char * dash_file = dashfile();
            char * path = get_path();
            if(strcmp(dash_file, "--file") != 0 || strcmp(dash_str, "--str") != 0){
                printf("invalid command\n");
                continue;
            }
            if(does_exist(path) == 0){
            ...
            char * dash_file = dashfile();
            char * path = get_path();
            if(strcmp(dash_file, "--file") != 0 || strcmp(dash_str1, "--str") != 0 || strcmp(dash_str2, "--str") != 0){
                printf("invalid command\n");
                continue;
            }
            if(does_exist(path) == 0){
